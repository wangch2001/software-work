        ...
        <el-dialog title="地图展示" :visible.sync="dialogVisible_show" width="80%">
            <el-container>
                <el-aside style="width: 50%;">
                    <vl-map :load-tiles-while-animating="true" :load-tiles-while-interacting="true" style="height: 800px;"
                        ...
                        <vl-view :zoom.sync="location.zoom" :center.sync="location.center"
                            :rotation.sync="location.rotation"></vl-view>
            ...
            <span slot="footer" class="dialog-footer">
                <el-select v-model="drawOption" placeholder="请选择绘制图形">
                    <el-option v-for="item in drawOptions" :key="item.value" :label="item.label"
